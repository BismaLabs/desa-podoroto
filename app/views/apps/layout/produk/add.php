            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Tambah Produk</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="add-user">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor" id="post" name="isi_produk" rows="6" placeholder="Masukkan Isi Produk"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Keywords</label>
                                <input type="text" class="form-control" name="keywords" placeholder="Masukkan Kata Kunci Produk">
                            </div>
                            <div class="form-group">
                                <label for="artilces">Descriptions</label>
                                <textarea class="form-control" id="post" name="descriptions" rows="3" placeholder="Masukkan Deskripsi Singkat Produk"></textarea>
                            </div>
