...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" style="text-transform: uppercase;">
            ...
            <li <?php if(isset($lembaga)) { echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>apps/lembaga/"><i class="fa fa-briefcase"></i> <span>Lembaga Desa</span></a></li>
            ...
            <li <?php if(isset($video)) { echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>apps/video/"><i class="fa fa-youtube-play"></i> <span>Galeri Video</span></a></li>
