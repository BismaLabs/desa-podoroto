            ...
            <?php else : ?>
                <div class="col-md-12">
                    ...
                    <div class="reload" style="text-align: center;margin-bottom: 7px">
                        <a  href="<?php echo base_url('kategori?source=reload&utf8=✓') ?>" class="btn btn-md btn-default" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Reloading..."><i class="fa fa-repeat"></i> Muat Ulang Halaman</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
