<div class="blog-section" style="padding-top: 20px">
    <div class="container">
        ...
        <div class="row" style="text-align: center">
            <button class="btn btn-md btn-default" id="load_more_kategori" data-val = "0">Lihat Kategori Lainnya <img style="display: none" id="loader" src="<?php echo base_url('resources/images/loader.svg') ?>" style="width: 5px;height: 5px"> </button>
        </div>
    </div><!-- end container -->
</div>